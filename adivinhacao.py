    ...
    def jogar():
        ...
        global tentativas
        while tentativas > 0
            numeroDigitado = int(input("Digite um número de 1 a 100 para tentar adivinhar o número secreto: "))]
    ...
    def dica(numeroEscolhido: int):
        ...
        if numeroEscolhido > numeroSecreto:
            return "O numero escolhido é maior que o número secreto, ", numeroEscolhido
        else:
            return "O número escolhido é menor que o número secreto, ", numeroEscolhido
